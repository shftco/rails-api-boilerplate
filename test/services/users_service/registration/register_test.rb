...
class UsersService::Registration::RegisterTest < ActiveSupport::TestCase
  def setup
  ...
  test 'should register user' do
    assert_difference('User.count', 1) do
      service = UsersService::Registration::Register.new(params: @params).call
  ...
  test 'should fail if user service returns failure' do
    ...
    UsersService::Create.expects(:new).returns(branch_user_service)
