    ...
    module Registrations
      class CreateTest < ActiveSupport::TestCase
        ...
        test 'should pass contract validation then calling the service' do
          ...
          contract_mock = mock
          V1::UsersContract::Registrations::Register.expects(:new).returns(contract_mock)
          ...
          operation = V1::UsersOperation::Registrations::Create.new(params: params_mock, doorkeeper_application:).call
        ...
        test 'should return errors if something goes wrong while validating params' do
          ...
          operation = V1::UsersOperation::Registrations::Create.new(params: {}, doorkeeper_application:).call
