    ...
    module Passwords
      class CreateTest < ActiveSupport::TestCase
        test 'should pass contract validation then calling the service' do
          ...
          contract_mock = mock
          V1::UsersContract::Passwords::SendInstructions.expects(:new).returns(contract_mock)
          ...
          service_mock = mock
          UsersService::Passwords::SendInstructions.expects(:new).returns(service_mock)
          service_mock.expects(:call).returns(Dry::Monads::Result::Success.new(true))

          operation = V1::UsersOperation::Passwords::Create.new(params: params_mock).call
        ...
        test 'should return errors if something goes wrong while validating params' do
          service_mock = mock
          UsersService::Passwords::SendInstructions.expects(:new).returns(service_mock).never

          operation = V1::UsersOperation::Passwords::Create.new(params: {}).call
