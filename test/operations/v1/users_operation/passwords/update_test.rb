    ...
    module Passwords
      class UpdateTest < ActiveSupport::TestCase
        test 'should pass contract validation then calling the service' do
          ...
          contract_mock = mock
          V1::UsersContract::Passwords::Update.expects(:new).returns(contract_mock)
          ...
          operation = V1::UsersOperation::Passwords::Update.new(params: params_mock).call
        ...
        test 'should return errors if something goes wrong while validating params' do
          ...
          operation = UsersOperation::Passwords::Update.new(params: {}).call
