...
class Users::Registrations::CreateOperationTest < ActiveSupport::TestCase
  test 'should pass contract validation then calling the service' do
    ...
    contract_mock = mock
    Users::RegistrationContract.expects(:new).returns(contract_mock)
    ...
    service_mock = mock
    UsersService::Registration::Register.expects(:new).returns(service_mock)
  ...
  test 'should return errors if something goes wrong while validating params' do
    service_mock = mock
    UsersService::Registration::Register.expects(:new).returns(service_mock).never
